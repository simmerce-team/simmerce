...
const ProductDetailPage = async ({ params }: { params: Params }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50/30 md:py-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>{product.business?.address}</CardDescription>
                  ...
                  <div className="space-y-2 text-sm text-slate-700">
                    {product.stock_quantity > 0 ? (
                      <p className="flex items-center">
                        ...
                        In Stock ({product.stock_quantity.toLocaleString()}{" "}
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 mt-1">
                        Member since{" "}
                        {new Date(
                          product.business?.created_at || new Date()
                        ).getFullYear()}
                      </p>
                    </div>
                  </div>
