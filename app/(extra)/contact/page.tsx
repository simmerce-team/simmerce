              ...
              <CardContent className="space-y-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">For general inquiries and support</p>
                    <a href="mailto:contact@simmerce.com" className="text-sm text-red-600 hover:underline">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+911234567890" className="text-sm text-red-600 hover:underline">
                      +91 12345 67890
                    </a>
                    <p className="text-xs text-slate-500 mt-1">Monday - Friday, 9 AM - 6 PM IST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Simmerce Technologies Pvt. Ltd.</p>
                    <p className="text-sm text-slate-600">123 Business Park, Sector 44</p>
                    <p className="text-sm text-slate-600">Gurugram, Haryana 122002</p>
                  </div>
                </div>
              </CardContent>
            </Card>
